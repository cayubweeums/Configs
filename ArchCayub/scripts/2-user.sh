...
if [[ $INSTALL_TYPE == "FULL" ]]; then
  if [[ $DESKTOP_ENV == "kde" ]]; then
    ...
    cp -r ~/ArchTitus/configs/Pictures/* ~/Pictures/
    cp ~/ArchTitus/post-install.sh ~/Documents/
    cp ~/ArchTitus/configs/Cayub-Bismuth-KDE.tar.gz ~/Documents/
    cp ~/ArchTitus/configs/Cayub-Bismuth-Keyboard-Shortcuts.kksrc ~/Documents/
